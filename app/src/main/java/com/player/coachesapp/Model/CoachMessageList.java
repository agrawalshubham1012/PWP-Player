...
public class CoachMessageList {

    @SerializedName("co_access_token")
    private Object coAccessToken;
    ...
    @SerializedName("co_notification")
    private String coNotification;
    ...
    @SerializedName("co_sport")
    private String coSport;
    ...
    public Object getCoAccessToken() {
        return coAccessToken;
    }

    public void setCoAccessToken(Object coAccessToken) {
    ...
    public String getCoNotification() {
        return coNotification;
    }

    public void setCoNotification(String coNotification) {
        this.coNotification = coNotification;
    }
    ...
    public String getCoSport() {
        return coSport;
    }

    public void setCoSport(String coSport) {
